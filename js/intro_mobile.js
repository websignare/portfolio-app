...
function hp__mobile__activate(bar_gr) {
    ...
    hp__mobile__create_responsive(bar_gr);
    //current_page = "web_development"
}
    
function hp__mobile__deactivate(bar_gr) {
...
function hp__mobile__create_responsive(bar_gr) {
    ...
    hp__mobile(hp__mobile__container_gr, bar_gr, screen_width_in_px, screen_height,  double_screen_height)
    create_mobile_contact_section(screen_width_in_px,screen_height)
}

//----------------------------------------------hp__mobile----------------------------------------------------------------
function hp__mobile(parent_gr, bar_gr, screen_width_in_px, screen_height, double_screen_height){
    ...
    var menu_line_top     = menu_rect_gr.line(3, 20, 40, 20).stroke({ width: 5, color: '#afb1b0ff', linecap: 'round' })
    var menu_line_midddle = menu_rect_gr.line(3, 35, 40, 35).stroke({ width: 5, color: '#afb1b0ff', linecap: 'round' })
    var menu_line_bottom  = menu_rect_gr.line(3, 50, 40, 50).stroke({ width: 5, color: '#afb1b0ff', linecap: 'round' })
    ...
    ui_and_ux.fill('#fff')
    ui_and_ux.move(screen_width_in_px/2-10,screen_height/2),
    ui_and_ux.scale(3.3)
    ...
    nevena.move(screen_width_in_px/2-nevena.bbox().width/2,ui_and_ux.bbox().y-70)
    //nevena.rotate(180)
    nevena.scale(3.5)
    ...
    moodboard__gr.attr({
        x:      0,
        y:      design__gr.bbox().height+20+development__gr.bbox().height+20,
    ...
    contact_underline.stroke({ width: 3, color: "#ba3e56fe", linecap: 'round' })
    
    contact__gr.attr({
        x: 0,
        y: double_screen_height-contact__gr.bbox().height-20
    ...
    des_dev_mood__gr.attr({
        x: 0,
        y: double_screen_height/2+design__gr.bbox().height+10
    })
    ...
    var initial_coords = {
        ...
        "dots":      {x:screen_width_in_px,y:dots.y()},
    }

    var final_coords = {
        "parentheses": {x:parentheses.x(),y:parentheses.y()},
        "ui_and_ux":   {x:ui_and_ux.x(),y:ui_and_ux.y()},
        "dots":      {x:dots.x(),y:dots.y()},
    }

    animate_hp__mobile__activate(hp__mobile_info, initial_coords, final_coords, screen_width_in_px, screen_height)
    animate_hp__mobile__deactivate(hp__mobile_info, initial_coords, final_coords, screen_width_in_px, screen_height)

}
//---------------------ANIMATE hp__mobile-------------------------------------------------
function animate_hp__mobile__activate(hp__mobile_info, initial_coords, final_coords, screen_width_in_px, screen_height) {
    ...
    .after(function() {
        ...
        dots.attr({x: initial_coords["dots"]["x"] })
        ...
        dots.animate({
            duration: 550,
        }).attr({x: final_coords["dots"]["x"] })
    });
}

function animate_hp__mobile__deactivate(hp__mobile_info, initial_coords, final_coords, screen_width_in_px, screen_height){
