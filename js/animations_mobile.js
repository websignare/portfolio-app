...
function animations_mobile(parent_gr, screen_width_in_px, height, screen_height) {
    ...
    animation_a_gr.attr({
        x:     screen_width_in_px/2-animation_a.bbox().width/2,
        y:     50
    })
    fit_image_inside_rect(animation_a_gr, image_url_a, rect_width, rect_height, 0, 0, 0, 0)
    create_play_button("rect_follows_cursor", animation_a_gr, '0,0 0,150 150,75', animation_a_gr.bbox().width/4, animation_a_gr.bbox().height/4, screen_width_in_px, screen_height)
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    var animation_c = animation_c_gr.rect(rect_width,rect_height)
    animation_c.attr({
        fill: "#000",
        x:     0,
        y:     0
    ...
    create_play_button("three_rects_connected", animation_c_gr, '0,0 0,150 150,75',animation_c_gr.bbox().width/4, animation_c_gr.bbox().height/4, screen_width_in_px, screen_height)
/////////////////////////////////////////////////////////////////////////////////////
    ...
    create_play_button("rect_on_x", animation_d_gr, '0,0 0,150 150,75', animation_d_gr.bbox().width/4, animation_d_gr.bbox().height/4, screen_width_in_px, screen_height)
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    create_play_button("points_on_edges", animation_e_gr,'0,0 0,150 150,75', animation_e_gr.bbox().width/4, animation_e_gr.bbox().height/4, screen_width_in_px, screen_height)
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    create_play_button("", animation_f_gr,'0,0 0,150 150,75', animation_f_gr.bbox().width/4, animation_f_gr.bbox().height/4, screen_width_in_px, screen_height)
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    create_play_button("", animation_g_gr, '0,0 0,150 150,75', animation_g_gr.bbox().width/4, animation_g_gr.bbox().height/4, screen_width_in_px, screen_height)
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    create_play_button("", animation_h_gr, '0,0 0,150 150,75', animation_h_gr.bbox().width/2, animation_h_gr.bbox().height/2, screen_width_in_px, screen_height)
