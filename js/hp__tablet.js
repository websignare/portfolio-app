...
function hp_tablet__activate(bar_gr) {
...
function hp_tablet__create_responsive(bar_gr) {
    ...
    var container    = SVG().addTo("#hp_tablet #wrapper").size(screen_width_in_px, screen_height)
...
//----------------------------------------------CREATE-LAYOUT-tablet----------------------------------------------------------------
function hp_tablet__create_background__tablet(parent_gr, screen_width_in_px, screen_height){

    var tablet_home_layout_gr = parent_gr.nested().attr({id: 'tablet_home_layout_gr'})

    var home_orange_background_gr = tablet_home_layout_gr.nested()
        .attr({
    ...
    var tablet_white_background_gr = home_orange_background_gr.nested().attr({id :"tablet_white_background_gr"})

    var tablet_white_background = tablet_white_background_gr.rect(screen_width_in_px-100,screen_height-100)
    .fill('#D9D9D9')
    .attr({
        id:      "tablet_white_background",
        opacity: 1.0,
        'x':     50,
        'y':     50
    })
    return tablet_home_layout_gr;

}

//----------------------------------------------TEXT----------------------------------------------------------------
function nevena_create_text__tablet(parent_gr, screen_width_in_px, screen_height) {
    ...
    parentheses.fill('#bdbdbdff').move(screen_width_in_px-parentheses.bbox().width+5,screen_height/2-parentheses.bbox().height/2)
...
//----------------------------------------------IMAGES-tablet----------------------------------------------------------------
function section_images__tablet(parent_gr){

    var images_gr_width  = parent_gr.bbox()[0].width-250;
    ...
    //               has to be set beforehnevena_create_text__tablet(images_gr)
...
function buttons_tablet(parent_gr, bar_gr, screen_height, screen_width_in_px){
    ...
    //--------------------------UX----------------------------------
    var ux_gr                = buttons_tablet_gr.nested();
    ...
    //--------------------------CONTACT----------------------------------
    var contact_gr          = buttons_tablet_gr.nested()
    ...
    //--------------------------DESIGN----------------------------------
    var design_gr = buttons_tablet_gr.nested()
    var design_base_image  = parent_gr.findOne("#image_element_2");
    ...
    //--------------------------DEVELOPMENT----------------------------------
    var development_gr                = buttons_tablet_gr.nested();
    var development_base_image_first  = parent_gr.findOne("#image_element_3");
    var development_base_image_second = parent_gr.findOne("#image_element_4");
    ...
    //--------------------------NEVENA----------------------------------
    var nevena_gr                = buttons_tablet_gr.nested();
