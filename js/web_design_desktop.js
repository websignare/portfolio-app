...
function web_design_create_responsive(bar_gr) {
    ...
    if (screen_physical_width_cm < 20.5) {
        ...
        web_design_text__desktop(container_gr, screen_width_in_px, screen_height)
...
function web_design__intro_section__desktop(parent_gr, bar_gr, screen_width_in_px, screen_height){
    ...
    comment_symbol.move(comment_symbol.bbox().width-20,screen_height/2+30)
    //comment_symbol.rotate(180)
    comment_symbol.scale(5.3)
...
function web_design_text__desktop(parent_gr, screen_width_in_px, screen_height){
    ...
    wdesign_path.move(screen_width_in_px/2-wdesign_path.bbox().width-355,screen_height/2-wdesign_path.bbox().height-120)
    ...
    paragraph.attr({
        x: screen_width_in_px/2-paragraph.bbox().width-195,
...
function web_design__images__desktop(parent_gr, screen_width_in_px, screen_height){
    ...
    var b_rect = b_rect_gr.rect(b_rect_width,rect_height*2.5)
    b_rect.attr({
            fill: "#df7f6cff",
            x: b_rect_x,
            y: b_rect_y-rect_height*2.5
        })
    ...
    var d_rect = d_rect_gr.rect(d_rect_width,rect_height*3.2)
        .attr({
            fill: "#df7f6cff",
            x: d_rect_x,
