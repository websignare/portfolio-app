...
function close_mobile__menu(parent_gr, menu_info){
    ...
    .fill("#d9d26cff")
    var line_top        = close_mobile__menu_gr.line(5, 5, 40, 40).stroke({color: '#467f8cff', width: 6, linecap: 'round', opacity: 1.0 })
    var line_bottom     = close_mobile__menu_gr.line(40, 5, 5, 40).stroke({color: '#467f8cff', width: 6, linecap: 'round', opacity: 1.0 })
