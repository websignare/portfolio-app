...
function moodboard__mobile__create_responsive(bar_gr) {
    ...
    var moodboard__mobile_info = moodboard_headline__mobile(headline_canvas__gr, bar_gr, screen_width_in_px, screen_height)
...
function moodboard_headline__mobile(parent_gr, bar_gr, screen_width_in_px, screen_height){
    ...
    var moodboard__mobile_info = {
        "moodboard_path":         moodboard_path,
        "square_brackets_symbol": square_brackets_symbol,
...
function moodboard_top__animate(moodboard__mobile_info, screen_width_in_px, screen_height){
    var moodboard_path         = moodboard__mobile_info["moodboard_path"];
    var square_brackets_symbol = moodboard__mobile_info["square_brackets_symbol"];
    var background_img__gr     = moodboard__mobile_info["background_img__gr"];
    var menu_rect_gr           = moodboard__mobile_info["menu_rect_gr"];

    square_brackets_symbol.animate({
        duration: 600,
    }).attr({
        opacity: 1.0
    })
    moodboard_path.animate({
        delay: 200,
        duration: 1000,
        ease: '<'
    }).move(screen_width_in_px-moodboard_path.bbox().width+91,menu_rect_gr.bbox().height+moodboard_path.bbox().height+45)
    .attr({
        opacity: 1.0
    })
