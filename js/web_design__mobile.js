...
function web_design_intro__info(parent_gr, bar_gr, screen_width_in_px, screen_height){
    ...
    //---------------------------SYMBOL----------------------------------
    var comment_symbol_gr = web_design_container__gr.nested().fill("#0000000")   
    ...
    var menu_line_top     = menu_rect_gr.line(3, 20, 40, 20).stroke({ width: 5, color: '#533065ff', linecap: 'round' })
    var menu_line_midddle = menu_rect_gr.line(3, 35, 40, 35).stroke({ width: 5, color: '#533065ff', linecap: 'round' })
    var menu_line_bottom  = menu_rect_gr.line(3, 50, 40, 50).stroke({ width: 5, color: '#533065ff', linecap: 'round' })
    ...
    //---------------------WEB-DESIGN-TITLE--------------------
    var wdesign_path__gr = web_design_container__gr.nested()
