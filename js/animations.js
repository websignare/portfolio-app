...
function animations(parent_gr, screen_width_in_px, height, screen_height) {
    ...
    if (screen_physical_width_cm < 33.8) {
        ...
        var rect_height = screen_height/2+50;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("three_rects_connected", animation_c_gr, '0,0 0,220 220,110', animation_c_gr.bbox().width/4, animation_c_gr.bbox().height/4, screen_width_in_px, screen_height)
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("rect_on_x", animation_d_gr, '0,0 0,220 220,110', animation_d_gr.bbox().width/4, animation_d_gr.bbox().height/4, screen_width_in_px, screen_height)
    ...
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("points_on_edges", animation_e_gr, '0,0 0,220 220,110', animation_e_gr.bbox().width/4, animation_e_gr.bbox().height/4, screen_width_in_px, screen_height)
    ...
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("", animation_f_gr, '0,0 0,220 220,110', animation_f_gr.bbox().width/4, animation_f_gr.bbox().height/4, screen_width_in_px, screen_height)
    ...
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("", animation_g_gr, '0,0 0,220 220,110', animation_g_gr.bbox().width/4, animation_g_gr.bbox().height/4, screen_width_in_px, screen_height)
    ...
    /////////////////////////////////////////////////////////////////////////////////////
        ...
        create_play_button("", animation_h_gr, '0,0 0,220 220,110', animation_h_gr.bbox().width/4, animation_h_gr.bbox().height/4, screen_width_in_px, screen_height)
    }
